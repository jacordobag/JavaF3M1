package modulo1fase3.proyecto.controllers.handlers;

import modulo1fase3.proyecto.exceptions.ElementNotFoundException;
import modulo1fase3.proyecto.model.RespuestaError;
...
public class ManejadorGlobalErrores {
    ...
    public ResponseEntity<?> clienteNoEncontrado(ElementNotFoundException ex, WebRequest request) {
        return RespuestaError.builder()
